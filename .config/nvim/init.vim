...
require("nvim-treesitter.configs").setup({
    ...
    ensure_installed = { "bash", "bibtex", "c", "cpp", "c_sharp", "cmake", "dart", "diff",
                         "dockerfile", "fish", "html", "java", "javascript", "kotlin",
                         "latex", "ledger", "lua", "make", "python", "rust", "scala",
                         "toml", "tsx", "typescript", "vimdoc", "vim", "yaml" },
